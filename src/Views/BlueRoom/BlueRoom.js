...
import PrincipalBlueRoom from "../../assets/images/ROOMS/BR/PrincipalBlueRoom.jpg";
import Dresser from "../../assets/images/ROOMS/BR/DresserBlueRoom.jpg";
import Door from "../../assets/images/ROOMS/BR/DoorBR.jpg";
import closet from "../../assets/images/ROOMS/BR/ClosetBR.jpg";
import Desk from "../../assets/images/ROOMS/BR/DeskBR.jpg";
import bathroom from "../../assets/images/ROOMS/bathroom.jpg";
import BottomNavigationAction from "@material-ui/core/BottomNavigationAction";
import WhatsAppIcon from "@material-ui/icons/WhatsApp";
import MailOutlineIcon from "@material-ui/icons/MailOutline";
import { Link } from "react-router-dom";
import CommentsArea from "../../Components/BlueRoom/CommetsAreaBlueRoom";
import styles from "./BlueRoom.module.css";

export default function BlueRoom() {
  return (
    <div>
      <div className={styles.title}>
        <h3 className={styles.T}>BlueRoom</h3>
      </div>
      <div className={styles.body}>
        <div className={styles.imgs}>
          <img
            className={styles.pricipalBlue}
            src={PrincipalBlueRoom}
            alt="principalBlue"
          />
          <img className={styles.deskBlueRoom} src={Desk} alt="deskBlueRoom" />
          <img
            className={styles.dresserBlueRoom}
            src={Dresser}
            alt="dresserBlueRoom"
          />
          <img className={styles.doorBlueRoom} src={Door} alt="doorBlueRoom" />
          <img
            className={styles.closetBlueRoom}
            src={closet}
            alt="closetBlueRoom"
          />
        ...
        <div className={styles.areaDescription}>
          ...
          >
            <button className={styles.btnBR}>I LIKE IT!!</button>
          </Link>
        </div>

        <div className={styles.commentsAreaBlue}>
          <CommentsArea />
        </div>
        <div className={styles.moreInfoBlue}>
