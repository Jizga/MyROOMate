  ...
  return (
    <div className="staticArea">
      ...
      <div className={styles.body}>
        ...
        <div className={classes.root} class={styles.myBox}>
          <AppBar position="static" class={styles.appBar}>
            <Tabs
              value={value}
            ...
            >
              <Tab
                label="Profile"
                {...a11yProps(0)}
                class={styles.titleProfile}
              />
              <Tab
                label="Your Room"
                {...a11yProps(1)}
                class={styles.titleUserRoom}
              />
              <Tab
                label="Access Data"
                {...a11yProps(2)}
                class={styles.titleUserData}
              />
            </Tabs>
          </AppBar>
          <SwipeableViews
