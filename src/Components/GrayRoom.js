      ...
      <div className="body">
        <div className="imgs">
          <img
            ...
            alt="principalGray"
            style={{ width: "15.5rem", height: "25.5rem" }}
          ></img>
          <img
        ...
        <p className="description" style={{ backgroundColor: "#C4C4C4" }}>
          Room for rent in apartment with elevator in front of the Ministries,
          in an area with a lot of atmosphere and bars of young people. It is 15
          minutes walk from the station, 20 from the center and 5 from the
          Jewish quarter. The price includes electricity, water, internet,
          community, cleaning of common areas and a bathroom for two people. The
          room has a double bed, a large table, a lot of storage area, ceiling
          fan, stove and a large window that provides plenty of light. The
          bathroom to share between two has a radiator and a dryer for tenants.
          The kitchen is fully equipped (dishwasher, washing machine, microwave,
          coffee maker, toaster, oven and fryer). Preferably students or person
          up to 30 - 35 years old.
          {"          "}
          <button className="btn">I LIKE IT!!</button>
        </p>
        <div className="commentsArea">Comments Area</div>
        <div className="moreInfo" style={{ backgroundColor: "#C4C4C4" }}>
          <p>
